...
USERNAME = environ.get('USERNAME', "https://telegram.me/Nishant_0786")
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002345195670'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/Ni_Movie_Request_Group')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002307916623').split()]
...
URL = environ.get('URL', 'https://rotten-linet-nishant0-7-0da16435.koyeb.app/')
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002386346176'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002357584908')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1008000054678'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002321412626'))
